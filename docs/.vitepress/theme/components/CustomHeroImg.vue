                        ...
                        <div
                            ...
                            <div class="flex items-center space-x-4 px-6 py-4">
                                <svg class="h-6 w-6 flex-none" fill="none">
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill="#fff"></path>
                                </svg><svg class="h-6 w-6 flex-none" fill="none">
                                    <path
                            ...
                            <div
                                ...
                                <svg class="ml-6 h-6 w-6 flex-none" fill="none">
                                    <path d="M14 5 9 9H6a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h3l5 4V5Z" fill="#64748B"
                                        stroke="#64748B" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                                    <path d="M19 12c0-1.5-1-2-1-2v4s1-.5 1-2Z" stroke="#64748B" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg><svg class="ml-6 h-6 w-6 flex-none" fill="none">
                                    <path
                            ...
                            <div>
                                ...
                                <div class="relative z-10 p-4">
                                    ...
                                    <div
                                        ...
                                        <svg class="h-6 w-6 flex-none stroke-slate-500" stroke-width="2"
                                            stroke-linecap="round" fill="none">
                                            <path d="M4 7h16M4 12h16M4 17h16"></path>
                                        </svg><svg class="ml-6 h-10 w-10 flex-none" viewBox="0 0 40 40" fill="none">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        </svg><svg viewBox="0 0 16 16" class="ml-6 h-6 w-6 fill-slate-400">
                                            <path
                        ...
                        <div class="relative p-4">
                            <div
                                ...
                                <div class="flex items-center px-3.5 py-2.5 text-slate-400">
                                    <svg class="mr-2 h-5 w-5 stroke-slate-500" fill="none" viewBox="0 0 24 24"
                                        stroke-width="2">
                                ...
                                <div class="border-t border-slate-400/20 px-3.5 py-3">
                                    ...
                                    <div class="flex items-center rounded-md p-1.5 bg-indigo-600 text-white">
                                        <svg class="mr-2.5 h-5 w-5 flex-none stroke-white" fill="none"
                                            viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round">
                            ...
                            <div
                                ...
                                <div class="mt-4 flex items-center border-t border-slate-400/20 py-3">
                                    <span class="w-2/5 flex-none">Language</span><span class="">English</span><span
                                        class="pointer-events-auto ml-auto font-medium text-indigo-600 hover:text-indigo-500">Update</span>
                                </div>
                                <div class="flex items-center border-t border-slate-400/20 py-3">
                                    <span class="w-2/5 flex-none">Date format</span><span
                                        ...
                                        class="ml-auto flex items-center font-medium text-indigo-600"><span
                                            class="pointer-events-auto hover:text-indigo-500">Update</span><span
                                            class="mx-3 h-6 w-px bg-slate-400/20"></span><span
                                            class="pointer-events-auto hover:text-indigo-500">Remove</span></span>
                                </div>
                                <div class="flex items-center border-t border-slate-400/20 py-3">
...
const { name, text, actions } = frontmatter.value.hero;
</script>
