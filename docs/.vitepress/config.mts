...
const ogDescription = '简单高效的机场前端物料库';
const ogTitle = 'Air UI';
const ogUrl = 'https://vite-plugin-web-extension.aklinker1.io';
const ogImage = 'https://github.com/aklinker1/vite-plugin-web-extension/raw/main/.github/assets/social-banner.png';
...
export default defineConfig({
    ...
    themeConfig: {
        ...
        editLink: {
            pattern: 'https://github.com/aklinker1/vite-plugin-web-extension/edit/main/docs/:path',
