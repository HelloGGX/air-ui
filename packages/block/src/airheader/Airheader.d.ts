...
export interface AirheaderProps { title?: string; }
export interface AirheaderSlots { default(): VNode[]; }
export interface AirheaderEmitsOptions { click: (evt: MouseEvent) => void; }
